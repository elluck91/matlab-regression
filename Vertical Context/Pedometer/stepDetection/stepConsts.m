classdef stepConsts
    ...
    properties (Constant)
        ...
        upperLimitOnWalkingDuration = 350; %7 seconds x sampling rate
        upperLimitOnNotWalkingDuration = 1500; %30 sec x samplingRate
        ...
        stepFreqThreshForWindowSearch = 2.1; %2.1Hz
