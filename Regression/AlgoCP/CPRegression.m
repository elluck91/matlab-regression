function CPRegression(settings, index)
...
algoOutput = CPRegressionAlgo(accelData, algoOutput);
...
Algorithm_Accuracy = CPResultProcess(algoOutput, smartGt, settings, index);
